...
megamega_rest:
	${CXX} $(make_mega_obj) vec2.cpp -o vec2.o
	${CXX} $(make_mega_obj) hp_bar.cpp -o hp_bar.o $(mega_sdl)
	${CXX} $(make_mega_obj) level_rooms.cpp -o level_rooms.o $(mega_sdl)
	${CXX} $(make_mega_obj) actors.cpp -o actors.o $(mega_sdl)
	${CXX} $(make_mega_obj) items.cpp -o items.o $(mega_sdl)
	${CXX} $(make_mega_obj) projectiles.cpp -o projectiles.o $(mega_sdl)
	${CXX} $(make_mega_obj) inputs.cpp -o inputs.o
	${CXX} $(make_mega_obj) tiles.cpp -o tiles.o
	${CXX} $(make_mega_obj) player_chara.cpp -o player_chara.o $(mega_sdl)
	${CXX} $(make_mega_obj) settings_file.cpp -o settings_file.o
	${CXX} $(make_mega_obj) game_data.cpp -o game_data.o $(mega_sdl) $(mega_sdl)
	${CXX} $(make_mega_obj) backend_sdl.cpp -o backend_sdl.o $(mega_lodepng) $(mega_sdl)
	${CXX} $(make_mega_obj) $(mega_lodepng_cpp) -o lodepng.o $(mega_lodepng)
	${CXX} $(make_mega_exe) vec2.o hp_bar.o level_rooms.o actors.o items.o settings_file.o projectiles.o inputs.o tiles.o player_chara.o game_data.o backend_sdl.o lodepng.o main.cpp -o ${mega_exe} -Wall -std=c++17 $(mega_lodepng) $(mega_sdl) -DSDL_MAIN_HANDLED
	./${mega_exe}
	
megamega_settings_test:
	${CXX} $(make_mega_obj) settings_file.cpp -o settings_file.o -I
	${CXX} $(mega_test_dir) settings.cpp settings_file.o -Wall -std=c++17 -o settings_test -I
	
megamega:
	${CXX} $(make_mega_obj) stage_select.cpp -o stage_select.o $(mega_sdl)
